...
namespace Repository
{
    public class RepositoryManager : IRepositoryManager
    {
        ...
        private readonly Lazy<IVideoRatingRepository>  _videoRatingRepository;
        ...
        public RepositoryManager(WebReviewsContext webReviewsContext)
        {
            ...
            _videoRatingRepository = new Lazy<IVideoRatingRepository>(() => new VideoRatingRepository(webReviewsContext));
        }
        ...
        public IVideoRatingRepository VideoRating => _videoRatingRepository.Value;
